...
class SimForegroundService : Service() {
    ...
    private fun connectToWebSocket() {
        serviceScope.launch {
            try {
                // Point this to your FastAPI local ngrok or production live link gateway
                client.webSocket(host = "your-backend-gateway.ngrok-free.dev", path = "/ws/sms") {
                ...
                // Implement exponential backoff retry algorithms here for self-healing
                delay(5000)
                connectToWebSocket()
            }
        }
